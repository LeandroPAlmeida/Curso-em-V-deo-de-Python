...
#Professor
times = ('Atlético-MG', 'Flamengo', 'Palmeiras', 'Bragantino', 'Corinthians', 'Fortaleza', 'Internacional',
         'América-MG', 'Fluminense', 'Athletico-PR', 'Santos', 'Cuiabá', 'Ceará SC', 'Atlético-GO', 'São Paulo',
